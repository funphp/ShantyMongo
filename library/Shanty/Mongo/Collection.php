...
abstract class Collection
{
	...
	{
            /* this funciton return error when valid document
		/*if (!static::isDocumentClass()) {
			throw new ShantyException(get_called_class().' is not a document. Please extend Shanty\Mongo\Document');
		}*/
	...
	{
		if ($writable) $connection = \Shanty\Mongo::getWriteConnection(static::getConnectionGroupName());
		else $connection = \Shanty\Mongo::getReadConnection(static::getConnectionGroupName());
