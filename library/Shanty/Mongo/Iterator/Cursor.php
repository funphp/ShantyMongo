...
namespace Shanty\Mongo\Iterator;

use Shanty\Mongo\DocumentSet;
 ...
 * @author     Coen Hyde
 */
class Cursor implements \OuterIterator
{
	 ...
	 *
	 * @return Shanty\Mongo\DocumentSet
	 */
	public function makeDocumentSet()
	{
		...
		$config['requirementModifiers'] = array(
			DocumentSet::DYNAMIC_INDEX => array("Document:".$this->getDocumentClass())
		);
